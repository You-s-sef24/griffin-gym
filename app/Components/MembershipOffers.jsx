...
export default function MembershipOffers() {
  ...
  const offers = gym.membershipPlans.map((offer) => {
    return (
      <MembershipCard
        title={offer.title}
        image={offer.image}
  ...
  const programs = gym.privatePrograms.map((program) => {
    return (
      <ProgramCard
        title={program.title}
        desc={program.desc}
  ...
  return (
    <div id="memberships" className="pb-10" dir={lang === "EN" ? "ltr" : "rtl"}>
      <div className="flex flex-col items-center pt-18">
        ...
        <h3 className="text-white text-4xl mb-2">Membership Offers</h3>
        <hr className="text-red-600 w-1/5 border-3 mb-6" />
        <p className="text-neutral-500">
          Choose the plan that fits your fitness journe
        </p>
      ...
      <div className="flex flex-col items-center pt-18">
        ...
        <h3 className="text-white text-4xl mb-2">Private Training Programs</h3>
        <hr className="text-red-600 w-1/5 border-3 mb-6" />
        <p className="text-neutral-500">
          Get personalized guidance with our expert trainers
        </p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-15">
          {programs}
        </div>
