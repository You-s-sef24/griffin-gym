        ...
        <div className="relative w-full max-w-sm rounded-2xl bg-[#111] text-white overflow-hidden border border-neutral-800 hover:border-red-600 hover:scale-105 transition-all">
            ...
            <div className="p-5 flex flex-col gap-4">
                ...
                <div className="mt-4 flex flex-col gap-3">
                    <a href="" className="text-center bg-red-600 hover:bg-red-700 transition-all rounded-xl py-2 font-semibold">
                        Contact Us for Details
                    </a>

                    <a href="#contact" className="border border-gray-600 hover:border-white transition-all text-center rounded-xl py-2 text-sm">
                        Visit Gym
                    </a>
                </div>
            </div>
